...
function setup() {
  ...
  banana_right_Ani.frameDelay = 10;
	...
	avo_stay_Ani = loadAnimation('avo_down_1.png');
	avo_up_Ani = loadAnimation('avo_up_1.png','avo_up_2.png','avo_up_3.png');
  avo_up_Ani.frameDelay = 10;
	avo_down_Ani = loadAnimation('avo_down_1.png','avo_down_2.png','avo_down_3.png');
  avo_down_Ani.frameDelay = 10;
	avo_left_Ani = loadAnimation('avo_left_1.png','avo_left_2.png');
  avo_left_Ani.frameDelay = 10;
	avo_right_Ani = loadAnimation('avo_right_1.png','avo_right_2.png','avo_right_3.png');
  avo_right_Ani.frameDelay = 10;
  	...
  	text('player2 choose character!', 180, 240); 
		...
		if(player1_prop == 0){
  		...
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
  		text('faster weapon', player1X - 60, player1Y - 80); 
		}
		else if(player1_prop == 1){
			textSize(20); 
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
  		text('got one blood back', player1X - 60, player1Y - 80); 
		}
		else if(player1_prop == 2){
			textSize(20); 
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
  		text('faster working speed', player1X - 60, player1Y - 80); 
		}
		if(player2_prop == 0){
			textSize(20); 
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
  		text('faster weapon', player2X - 60, player2Y - 80); 
		}
		else if(player2_prop == 1){
			textSize(20); 
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
  		text('got one blood back', player2X - 60, player2Y - 80); 
		}
		else if(player2_prop == 2){
			textSize(20); 
  		fill(0); 
			textFont('Arial'); 
			textStyle(NORMAL); 
	...
	if(scene == 3){
		if (keyCode === ENTER) {  
			if(user_choice == 1){
				...
				player1_up_Ani = avo_up_Ani;
				player1_stay_Ani = avo_stay_Ani;
				player1_down_Ani = avo_down_Ani;
				player1_left_Ani = avo_left_Ani;
				player1_right_Ani = avo_right_Ani;
			}
			scene = 4;
			user_choice = 1;
  }
	...
	if(scene == 4){
		...
		if (keyCode === ENTER) {  
			if(user_choice == 1){
				...
				player2_up_Ani = avo_up_Ani;
				player2_stay_Ani = avo_stay_Ani;
				player2_down_Ani = avo_down_Ani;
				player2_left_Ani = avo_left_Ani;
				player2_right_Ani = avo_right_Ani;
			}
			scene = 0;
  }
			}
